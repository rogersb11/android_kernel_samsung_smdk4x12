	...
	.file	"bounds.c"
@ GNU C (crosstool-NG linaro-1.13.1+bzr2644 - Linaro GCC 2014.01 - Cortex-A9) version 4.7.4 20140107 (prerelease) (arm-cortex_a9-linux-gnueabihf)
@	compiled by GNU C version 4.8.1, GMP version 5.0.2, MPFR version 3.1.2, MPC version 1.0.2
@ GGC heuristics: --param ggc-min-expand=100 --param ggc-min-heapsize=131072
@ options passed:  -nostdinc -I /home/brett/shifted/arch/arm/include
...
@ -iprefix /home/brett/Desktop/toolchains/arm-cortex_a9-linux-gnueabihf-linaro_4.7.4-2014.01/bin/../lib/gcc/arm-cortex_a9-linux-gnueabihf/4.7.4/
@ -isysroot /home/brett/Desktop/toolchains/arm-cortex_a9-linux-gnueabihf-linaro_4.7.4-2014.01/bin/../arm-cortex_a9-linux-gnueabihf/libc
@ -D __KERNEL__ -D __LINUX_ARM_ARCH__=7 -U arm -D CC_HAVE_ASM_GOTO
@ -D KBUILD_STR(s)=#s -D KBUILD_BASENAME=KBUILD_STR(bounds)
@ -D KBUILD_MODNAME=KBUILD_STR(bounds)
@ -isystem /home/brett/Desktop/toolchains/arm-cortex_a9-linux-gnueabihf-linaro_4.7.4-2014.01/bin/../lib/gcc/arm-cortex_a9-linux-gnueabihf/4.7.4/include
...
@ -mtune=cortex-a9 -mfpu=neon -mtls-dialect=gnu
...
@ 0 "" 2
	ldmfd	sp, {fp, sp, pc}	@
	.size	foo, .-foo
	.ident	"GCC: (crosstool-NG linaro-1.13.1+bzr2644 - Linaro GCC 2014.01 - Cortex-A9) 4.7.4 20140107 (prerelease)"
